...
const ExampleSection = () => {
    ...
    <div className="section example-section" id="exampleSection">
        <div>
            ...
            <p className="example-text">An AI model will scan your screenshots and identify UI defects.<br /> A heatmap will show the locations of the detected defects.</p>
        </div>
        <img className="example-image-result" src={ExampleResultImage} width={IMAGE_WIDTH} height={IMAGE_HEIGHT} />
    </div>
    )
}
